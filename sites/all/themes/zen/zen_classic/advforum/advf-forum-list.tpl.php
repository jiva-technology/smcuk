<?php
// $Id: advf-forum-list.tpl.php,v 1.6 2008/04/09 02:49:52 michellec Exp $
...
<table id="forum-<?php print $forum_id; ?>">
  <thead>
    <tr>
      <th><?php print t('Forum Name'); ?></th>
      <th><?php print t('# of Topics');?></th>
      <th><?php print t('# of Posts'); ?></th>
      <th><?php print t('Go Directly to Newest Forum Post'); ?></th>
    </tr>
  </thead>
  <tbody>
  <?php 
  ...
  <?php foreach ($forums as $child_id => $forum): ?>
    ...
    <td <?php 
      ...
      <?php if (!$forum->is_container): ?>
        <td class="topics">
      <a href="<?php print $forum->link; ?>"><?php print $forum->num_topics; ?></a>
          <?php if ($forum->new_topics): ?>
            <br />
            <a href="<?php print $forum->new_url; ?>"><?php print $forum->new_text; ?></a>
          <?php endif; ?>
        </td>
        <td class="posts"><a href="<?php print $forum->link; ?>"><?php print $forum->num_posts; ?></a></td>
