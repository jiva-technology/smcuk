; $Id: README.txt,v 1.1.2.7 2008/04/11 19:46:33 aronnovak Exp $
...
Feeds are based on content-types. By default the module will create two default
content-types for you. If you would setup more complex processor configuration,
